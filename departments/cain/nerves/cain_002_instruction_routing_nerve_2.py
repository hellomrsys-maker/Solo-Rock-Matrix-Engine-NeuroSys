...
class CAIN_002_InstructionRoutingNerve2(NerveBase):
    "\"\"
    COLLISION NERVE 2
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 62.
    "\"\"
    NERVE_ID = "CAIN_002"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 62 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_002] 3D Collision Node 2 ACTIVE.")
