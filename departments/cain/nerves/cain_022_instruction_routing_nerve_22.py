...
class CAIN_022_InstructionRoutingNerve22(NerveBase):
    "\"\"
    COLLISION NERVE 22
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 82.
    "\"\"
    NERVE_ID = "CAIN_022"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 82 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_022] 3D Collision Node 22 ACTIVE.")
