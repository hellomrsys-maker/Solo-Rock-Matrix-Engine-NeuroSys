...
class CAIN_071_InstructionRoutingNerve71(NerveBase):
    NERVE_ID = "CAIN_071"
    DEPARTMENT = "CAIN"
    ...
    def fire(self):
        ...
        if is_infected:
            ...
            for i in targets:
                if i != 71 and amsv_block.entities[i].health > 0 and amsv_block.entities[i].vx != 1.0:
