...
class CAIN_038_InstructionRoutingNerve38(NerveBase):
    "\"\"
    PROJECTILE PHYSICS NERVE
    Controls Bullet 7. Moves it forward and checks AABB collision against Swarm.
    "\"\"
    NERVE_ID = "CAIN_038"
    DEPARTMENT = "CAIN"
    ...
    def _physics_loop(self):
        print("[CAIN_038] Projectile Node 7 ACTIVE.")
