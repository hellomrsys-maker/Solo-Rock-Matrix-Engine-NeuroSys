...
class CAIN_068_InstructionRoutingNerve68(NerveBase):
    NERVE_ID = "CAIN_068"
    DEPARTMENT = "CAIN"
    ...
    def fire(self):
        ...
        if is_infected:
            ...
            for i in targets:
                if i != 68 and amsv_block.entities[i].health > 0 and amsv_block.entities[i].vx != 1.0:
