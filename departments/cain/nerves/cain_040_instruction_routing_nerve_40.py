...
class CAIN_040_InstructionRoutingNerve40(NerveBase):
    "\"\"
    PROJECTILE PHYSICS NERVE
    Controls Bullet 9. Moves it forward and checks AABB collision against Swarm.
    "\"\"
    NERVE_ID = "CAIN_040"
    DEPARTMENT = "CAIN"
    ...
    def _physics_loop(self):
        print("[CAIN_040] Projectile Node 9 ACTIVE.")
