...
class CAIN_041_InstructionRoutingNerve41(NerveBase):
    "\"\"
    PROJECTILE PHYSICS NERVE
    Controls Bullet 10. Moves it forward and checks AABB collision against Swarm.
    "\"\"
    NERVE_ID = "CAIN_041"
    DEPARTMENT = "CAIN"
    ...
    def _physics_loop(self):
        print("[CAIN_041] Projectile Node 10 ACTIVE.")
