...
class CAIN_011_InstructionRoutingNerve11(NerveBase):
    "\"\"
    COLLISION NERVE 11
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 71.
    "\"\"
    NERVE_ID = "CAIN_011"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 71 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_011] 3D Collision Node 11 ACTIVE.")
