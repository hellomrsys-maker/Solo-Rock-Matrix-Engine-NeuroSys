...
class CAIN_075_InstructionRoutingNerve75(NerveBase):
    NERVE_ID = "CAIN_075"
    DEPARTMENT = "CAIN"
    ...
    def fire(self):
        ...
        if is_infected:
            ...
            for i in targets:
                if i != 75 and amsv_block.entities[i].health > 0 and amsv_block.entities[i].vx != 1.0:
