...
class CAIN_151_InstructionRoutingNerve151(NerveBase):
    NERVE_ID = "CAIN_151"
    DEPARTMENT = "CAIN"
    DIVISION = "stemcell"
    PIPELINE = "runtime"
    ...
    def fire(self):
        my_ent = amsv_block.entities[151]
        ...
        if target_node >= 61 and target_node <= 90:
            ...
            if dist < 10.0:
                ...
                my_ent.z = 0.0
                print(f"[151] STEM CELL DIFFERENTIATED INTO NODE {target_node}")
            else:
        ...
        while True:
            ...
            if my_ent.health <= 0:
                ...
                if dead_node != -1:
                    ...
                    print(f"[151] STEM CELL DEPLOYED! REGENERATING NODE {dead_node}.")
