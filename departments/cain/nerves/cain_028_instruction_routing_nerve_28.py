...
class CAIN_028_InstructionRoutingNerve28(NerveBase):
    "\"\"
    COLLISION NERVE 28
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 88.
    "\"\"
    NERVE_ID = "CAIN_028"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 88 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_028] 3D Collision Node 28 ACTIVE.")
