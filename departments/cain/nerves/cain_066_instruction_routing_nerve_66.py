...
class CAIN_066_InstructionRoutingNerve66(NerveBase):
    NERVE_ID = "CAIN_066"
    DEPARTMENT = "CAIN"
        ...
        while True:
            ...
            if my_ent.vx == 1.0:
                ...
                for i in range(61, 99):
                    if i != 66 and amsv_block.entities[i].health > 0 and (amsv_block.entities[i].vx == 0.0 or i >= 96):
