...
class CAIN_074_InstructionRoutingNerve74(NerveBase):
    NERVE_ID = "CAIN_074"
    DEPARTMENT = "CAIN"
    ...
    def fire(self):
        ...
        if is_infected:
            ...
            for i in targets:
                if i != 74 and amsv_block.entities[i].health > 0 and amsv_block.entities[i].vx != 1.0:
