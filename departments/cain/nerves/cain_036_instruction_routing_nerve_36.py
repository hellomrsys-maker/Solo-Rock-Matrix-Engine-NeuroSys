...
class CAIN_036_InstructionRoutingNerve36(NerveBase):
    "\"\"
    PROJECTILE PHYSICS NERVE
    Controls Bullet 5. Moves it forward and checks AABB collision against Swarm.
    "\"\"
    NERVE_ID = "CAIN_036"
    DEPARTMENT = "CAIN"
    ...
    def _physics_loop(self):
        print("[CAIN_036] Projectile Node 5 ACTIVE.")
