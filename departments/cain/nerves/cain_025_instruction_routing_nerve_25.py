...
class CAIN_025_InstructionRoutingNerve25(NerveBase):
    "\"\"
    COLLISION NERVE 25
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 85.
    "\"\"
    NERVE_ID = "CAIN_025"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 85 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_025] 3D Collision Node 25 ACTIVE.")
