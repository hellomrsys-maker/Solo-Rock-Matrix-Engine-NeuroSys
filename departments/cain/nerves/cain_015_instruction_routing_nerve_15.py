...
class CAIN_015_InstructionRoutingNerve15(NerveBase):
    "\"\"
    COLLISION NERVE 15
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 75.
    "\"\"
    NERVE_ID = "CAIN_015"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 75 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_015] 3D Collision Node 15 ACTIVE.")
