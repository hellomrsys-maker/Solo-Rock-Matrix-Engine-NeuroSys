...
class CAIN_005_InstructionRoutingNerve5(NerveBase):
    "\"\"
    COLLISION NERVE 5
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 65.
    "\"\"
    NERVE_ID = "CAIN_005"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 65 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_005] 3D Collision Node 5 ACTIVE.")
