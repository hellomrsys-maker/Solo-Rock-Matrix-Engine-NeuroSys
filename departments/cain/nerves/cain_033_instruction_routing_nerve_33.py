...
class CAIN_033_InstructionRoutingNerve33(NerveBase):
    "\"\"
    PROJECTILE PHYSICS NERVE
    Controls Bullet 2. Moves it forward and checks AABB collision against Swarm.
    "\"\"
    NERVE_ID = "CAIN_033"
    DEPARTMENT = "CAIN"
    ...
    def _physics_loop(self):
        print("[CAIN_033] Projectile Node 2 ACTIVE.")
