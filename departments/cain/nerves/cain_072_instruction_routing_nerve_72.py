...
class CAIN_072_InstructionRoutingNerve72(NerveBase):
    NERVE_ID = "CAIN_072"
    DEPARTMENT = "CAIN"
    ...
    def fire(self):
        ...
        if is_infected:
            ...
            for i in targets:
                if i != 72 and amsv_block.entities[i].health > 0 and amsv_block.entities[i].vx != 1.0:
