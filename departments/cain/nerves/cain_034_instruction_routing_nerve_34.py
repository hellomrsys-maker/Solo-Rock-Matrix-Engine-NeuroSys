...
class CAIN_034_InstructionRoutingNerve34(NerveBase):
    "\"\"
    PROJECTILE PHYSICS NERVE
    Controls Bullet 3. Moves it forward and checks AABB collision against Swarm.
    "\"\"
    NERVE_ID = "CAIN_034"
    DEPARTMENT = "CAIN"
    ...
    def _physics_loop(self):
        print("[CAIN_034] Projectile Node 3 ACTIVE.")
