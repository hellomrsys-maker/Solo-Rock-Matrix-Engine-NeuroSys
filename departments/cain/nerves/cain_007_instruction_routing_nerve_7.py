...
class CAIN_007_InstructionRoutingNerve7(NerveBase):
    "\"\"
    COLLISION NERVE 7
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 67.
    "\"\"
    NERVE_ID = "CAIN_007"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 67 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_007] 3D Collision Node 7 ACTIVE.")
