...
class CAIN_030_InstructionRoutingNerve30(NerveBase):
    "\"\"
    COLLISION NERVE 30
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 90.
    "\"\"
    NERVE_ID = "CAIN_030"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 90 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_030] 3D Collision Node 30 ACTIVE.")
