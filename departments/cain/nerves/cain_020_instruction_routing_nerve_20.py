...
class CAIN_020_InstructionRoutingNerve20(NerveBase):
    "\"\"
    COLLISION NERVE 20
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 80.
    "\"\"
    NERVE_ID = "CAIN_020"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 80 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_020] 3D Collision Node 20 ACTIVE.")
