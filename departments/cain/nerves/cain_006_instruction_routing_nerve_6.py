...
class CAIN_006_InstructionRoutingNerve6(NerveBase):
    "\"\"
    COLLISION NERVE 6
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 66.
    "\"\"
    NERVE_ID = "CAIN_006"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 66 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_006] 3D Collision Node 6 ACTIVE.")
