...
class CAIN_027_InstructionRoutingNerve27(NerveBase):
    "\"\"
    COLLISION NERVE 27
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 87.
    "\"\"
    NERVE_ID = "CAIN_027"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 87 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_027] 3D Collision Node 27 ACTIVE.")
