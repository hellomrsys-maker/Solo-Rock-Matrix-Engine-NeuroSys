...
class CAIN_021_InstructionRoutingNerve21(NerveBase):
    "\"\"
    COLLISION NERVE 21
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 81.
    "\"\"
    NERVE_ID = "CAIN_021"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 81 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_021] 3D Collision Node 21 ACTIVE.")
