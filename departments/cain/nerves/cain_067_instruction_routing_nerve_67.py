...
class CAIN_067_InstructionRoutingNerve67(NerveBase):
    NERVE_ID = "CAIN_067"
    DEPARTMENT = "CAIN"
        ...
        while True:
            ...
            if my_ent.vx == 1.0:
                ...
                for i in range(61, 99):
                    if i != 67 and amsv_block.entities[i].health > 0 and (amsv_block.entities[i].vx == 0.0 or i >= 96):
