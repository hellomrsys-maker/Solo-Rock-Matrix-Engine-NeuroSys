...
class CAIN_070_InstructionRoutingNerve70(NerveBase):
    NERVE_ID = "CAIN_070"
    DEPARTMENT = "CAIN"
    ...
    def fire(self):
        ...
        if is_infected:
            ...
            for i in targets:
                if i != 70 and amsv_block.entities[i].health > 0 and amsv_block.entities[i].vx != 1.0:
