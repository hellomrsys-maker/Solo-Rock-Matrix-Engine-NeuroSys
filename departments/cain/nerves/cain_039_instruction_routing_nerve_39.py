...
class CAIN_039_InstructionRoutingNerve39(NerveBase):
    "\"\"
    PROJECTILE PHYSICS NERVE
    Controls Bullet 8. Moves it forward and checks AABB collision against Swarm.
    "\"\"
    NERVE_ID = "CAIN_039"
    DEPARTMENT = "CAIN"
    ...
    def _physics_loop(self):
        print("[CAIN_039] Projectile Node 8 ACTIVE.")
