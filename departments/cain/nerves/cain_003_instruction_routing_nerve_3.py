...
class CAIN_003_InstructionRoutingNerve3(NerveBase):
    "\"\"
    COLLISION NERVE 3
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 63.
    "\"\"
    NERVE_ID = "CAIN_003"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 63 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_003] 3D Collision Node 3 ACTIVE.")
