...
class CAIN_001_InstructionRoutingNerve1(NerveBase):
    "\"\"
    COLLISION NERVE 1
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 61.
    "\"\"
    NERVE_ID = "CAIN_001"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 61 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_001] 3D Collision Node 1 ACTIVE.")
