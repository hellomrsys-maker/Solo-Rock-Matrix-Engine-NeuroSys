...
class CAIN_032_InstructionRoutingNerve32(NerveBase):
    "\"\"
    PROJECTILE PHYSICS NERVE
    Controls Bullet 1. Moves it forward and checks AABB collision against Swarm.
    "\"\"
    NERVE_ID = "CAIN_032"
    DEPARTMENT = "CAIN"
    ...
    def _physics_loop(self):
        print("[CAIN_032] Projectile Node 1 ACTIVE.")
