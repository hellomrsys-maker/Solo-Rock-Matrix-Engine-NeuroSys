...
class CAIN_017_InstructionRoutingNerve17(NerveBase):
    "\"\"
    COLLISION NERVE 17
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 77.
    "\"\"
    NERVE_ID = "CAIN_017"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 77 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_017] 3D Collision Node 17 ACTIVE.")
