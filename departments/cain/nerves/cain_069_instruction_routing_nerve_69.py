...
class CAIN_069_InstructionRoutingNerve69(NerveBase):
    NERVE_ID = "CAIN_069"
    DEPARTMENT = "CAIN"
    ...
    def fire(self):
        ...
        if is_infected:
            ...
            for i in targets:
                if i != 69 and amsv_block.entities[i].health > 0 and amsv_block.entities[i].vx != 1.0:
