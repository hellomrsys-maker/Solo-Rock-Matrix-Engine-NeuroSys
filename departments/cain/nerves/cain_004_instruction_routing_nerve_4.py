...
class CAIN_004_InstructionRoutingNerve4(NerveBase):
    "\"\"
    COLLISION NERVE 4
    Autonomous neural node designed to calculate 3D AABB collisions for Swarm Entity 64.
    "\"\"
    NERVE_ID = "CAIN_004"
    DEPARTMENT = "CAIN"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 64 # Corresponds to Swarm Entity 61-90
    ...
    def _collision_loop(self):
        print("[CAIN_004] 3D Collision Node 4 ACTIVE.")
