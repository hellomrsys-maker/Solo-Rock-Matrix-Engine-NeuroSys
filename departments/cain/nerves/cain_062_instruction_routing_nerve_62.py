...
class CAIN_062_InstructionRoutingNerve62(NerveBase):
    NERVE_ID = "CAIN_062"
    DEPARTMENT = "CAIN"
        ...
        while True:
            ...
            if my_ent.vx == 1.0:
                ...
                for i in range(61, 99):
                    if i != 62 and amsv_block.entities[i].health > 0 and (amsv_block.entities[i].vx == 0.0 or i >= 96):
