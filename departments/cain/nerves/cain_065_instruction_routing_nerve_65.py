...
class CAIN_065_InstructionRoutingNerve65(NerveBase):
    NERVE_ID = "CAIN_065"
    DEPARTMENT = "CAIN"
        ...
        while True:
            ...
            if my_ent.vx == 1.0:
                ...
                for i in range(61, 99):
                    if i != 65 and amsv_block.entities[i].health > 0 and (amsv_block.entities[i].vx == 0.0 or i >= 96):
