...
class CAIN_037_InstructionRoutingNerve37(NerveBase):
    "\"\"
    PROJECTILE PHYSICS NERVE
    Controls Bullet 6. Moves it forward and checks AABB collision against Swarm.
    "\"\"
    NERVE_ID = "CAIN_037"
    DEPARTMENT = "CAIN"
    ...
    def _physics_loop(self):
        print("[CAIN_037] Projectile Node 6 ACTIVE.")
