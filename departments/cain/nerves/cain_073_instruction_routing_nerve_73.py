...
class CAIN_073_InstructionRoutingNerve73(NerveBase):
    NERVE_ID = "CAIN_073"
    DEPARTMENT = "CAIN"
    ...
    def fire(self):
        ...
        if is_infected:
            ...
            for i in targets:
                if i != 73 and amsv_block.entities[i].health > 0 and amsv_block.entities[i].vx != 1.0:
