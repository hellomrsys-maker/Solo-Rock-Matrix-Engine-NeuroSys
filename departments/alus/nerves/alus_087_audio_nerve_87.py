...
class ALUS_087_AudioNerve87(NerveBase):
    "\"\"
    SPATIAL AUDIO NERVE 87
    Autonomous neural node designed to emit Doppler audio for Entity 87.
    "\"\"
    NERVE_ID = "ALUS_087"
    DEPARTMENT = "ALUS"
    DIVISION = "audio"
    ...
    def __init__(self):
        super().__init__()
        self.entity_index = 87
        self.audio_thread = threading.Thread(target=self._audio_loop, daemon=True)
        self.audio_thread.start()

    def _audio_loop(self):
        print("[ALUS_087] Spatial Audio Node 87 ACTIVE.")
